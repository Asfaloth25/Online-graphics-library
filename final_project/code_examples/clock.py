...
Points([(0,0)], pointradius=1, pointcolor=(0,0,255), opacity=0.9)
Points([(0,0)], pointradius=0.95, pointcolor=(255,255,255), opacity=1)
...
# Las agujas
[Segment([(0,0), (0.1*i+0.6)*np.array(points[i])], linewidth = (4-i)*0.01, linecolor=(0,0,0), opacity=1) for i in range(3)]
